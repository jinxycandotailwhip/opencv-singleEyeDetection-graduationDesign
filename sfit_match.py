...
find_img1 = cv.imread("D:/studyfuckinghard/graduationcv/imgtest/find_cola.jpg")
img1 = cv.imread("D:/studyfuckinghard/graduationcv/imgtest/cola.jpg")
result = match_sift(img1, find_img1)
cv.imshow("find_img1", find_img1)
cv.imshow("img1", img1)
cv.imshow("result", result)
cv.imwrite("D:/studyfuckinghard/graduationcv/imgtest/find_cola_result.jpg", result)
cv.waitKey()
